...
var menus = [
             ...
             
             {
                 ...
                 items: [
                         ...
                         { text: "项目货物结算", id: "execution_settlement", imageUrl: "/images/padlock.png"},
                         ...
                         { text: "库存查询", id: "execution_repquery", imageUrl: "/images/shop.png"}
                     ]
             },
...

             {
                 ...
                 items: [
                     ...
                     { text: "直发签收单", id: "repository_repositoryout", imageUrl: "/images/rout.png"},
                     { text: "虚拟出入库单", id: "repository_repositoryouthistory", imageUrl: "/images/rout.png"}
                 ]
             },                                               
             {
...
//采购合同相关数据
//合同类型
var purchaseContractTypeNormal = [ {text : "上海代理产品"}, {text : "上海其他"}, {text : "施工分包"}, {text : "非代理产品"}];
