...
$(document).ready(function () {
	...
	$("#invoiceGrid").kendoGrid({
	    ...
	    columns: [
			...
			{ field: "payInvoiceMoney", title: "金额" ,footerTemplate: "总额: #=sum.toFixed(2)#"},
			{ field: "payInvoiceReceivedMoneyStatus", title: "收款情况"},
			{ field: "payInvoiceActualMoney", title: "实际金额" ,footerTemplate: "实际总额: #=sum.toFixed(2)#"},
	...
	$("#moneyGrid").kendoGrid({
	    ...
	    columns: [
			{ field: "_id", hidden: true},
			{ field: "creatorName", title: "申请人" ,footerTemplate: "总条数: #=count#"},
			{ field: "getMoneyActualMoney", title: "收款金额",footerTemplate: "总额: #=sum.toFixed(2)#" },
