...
public class PurchaseRequestBean {
	...
	public static final String SPECIAL_REQUIRE = "specialRequire";
	public static final String COMMENT = "comment";
	public static final String PC_EQ_LIST = "eqcostList";
	public static final String COST = "cost";
	public static final String COST_USED_GOODS = "costUsedGoods";
	public static final String COUNT_USED_REQUET = "countUsedRquest";
	public static final String PERCENT_USED_GOODS = "percentUsedGoods";
