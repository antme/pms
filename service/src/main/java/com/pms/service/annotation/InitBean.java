...
public class InitBean {
    ...
    private static void createSystemDefaultGroups(ICommonDao dao) {
        ...
        groupRoles.put(GroupBean.PROJECT_MANAGER_VALUE, new String[] {RoleValidConstants.PURCHASE_REQUEST_PROCESS,  RoleValidConstants.PURCHASE_CONTRACT_PROCESS});
        groupRoles.put(GroupBean.SALES_MANAGER_VALUE, new String[] {RoleValidConstants.PURCHASE_REQUEST_PROCESS, RoleValidConstants.PURCHASE_CONTRACT_PROCESS});

        groupRoles.put(GroupBean.PROJECT_ASSISTANT_VALUE, new String[] {RoleValidConstants.PROJECT_UPDATE, 
        		RoleValidConstants.SALES_CONTRACT_UPDATE, RoleValidConstants.PURCHASE_REQUEST_MANAGEMENT });
        groupRoles.put(GroupBean.SALES_ASSISTANT_VALUE, new String[] {RoleValidConstants.PROJECT_ADD, 
        		...
        		RoleValidConstants.SALES_CONTRACT_UPDATE, RoleValidConstants.PURCHASE_REQUEST_MANAGEMENT});
        groupRoles.put(GroupBean.PM, new String[] {RoleValidConstants.SHIP_MANAGEMENT, RoleValidConstants.BORROWING_MANAGEMENT});
        groupRoles.put(GroupBean.FINANCE, new String[] {});
        groupRoles.put(GroupBean.DEPOT_MANAGER_VALUE, new String[] {RoleValidConstants.SHIP_MANAGEMENT_PROCESS, RoleValidConstants.BORROWING_MANAGEMENT_PROCESS});
        groupRoles.put(GroupBean.PURCHASE_VALUE, new String[] { RoleValidConstants.PURCHASE_CONTRACT_MANAGEMENT,
                RoleValidConstants.PURCHASE_ORDER_MANAGEMENT, RoleValidConstants.PURCHASE_REQUEST_PROCESS, RoleValidConstants.PURCHASE_ORDER_PROCESS });
